    ...
    <div className="rounded-xl border border-violet-200 bg-gradient-to-br from-violet-50 to-indigo-50 p-4 space-y-3">
      ...
      <p className="text-xs text-violet-700">
        {isCreate
          ...
          : "Pídele cambios o pégale info: detecto si editar una sección existente o crear una nueva, y la ubico donde corresponde — sin tocar el resto. Ej: «las sedes…», «haz el tono más formal», «suma la promo 2x1»."}
      </p>
