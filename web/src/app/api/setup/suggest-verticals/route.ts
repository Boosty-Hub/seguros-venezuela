          ...
          .array(
            z.object({
              ...
              system_prompt: z
                .string()
                .describe(
                  "Instrucción breve (2-4 frases) para el agente sobre cómo manejar este tipo de mensaje, en la voz del operador. No incluyas el nombre del negocio literal; habla en segunda persona al agente."
                ),
              auto_reply: z
                .boolean()
                .describe(
