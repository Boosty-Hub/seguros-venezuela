      ...
      <div className="space-y-3">
        ...
        <div>
          <CapabilityCard
            ...
            description="Responde «¿tienes zapatos de niña talla 30? ¿cuánto salen?» con precio, variantes y disponibilidad reales. Incluye «los más vendidos» y ver categorías."
      ...
      <div className="space-y-2 rounded-xl border border-violet-200 bg-violet-50 p-4">
        ...
        <div className="space-y-1.5 pt-1">
          {[
            ...
            "Si quieren comprar, genera el link de pago del producto y la talla que eligieron.",
