        ...
        overview && (
          <div className="space-y-8">
            ...
            <section className="space-y-3">
              ...
              <StatRow>
                <StatCard label="Leads entrantes" value={overview.leads_entrantes} tone="brand" />
                <StatCard
                  label="Atendidos por el agente"
                  value={overview.atendidos_por_agente}
                  hint={pct(overview.atendidos_por_agente, overview.leads_entrantes)}
                  tone="default"
                />
                <StatCard
                  label="Transferidos a humano"
                  value={overview.transferidos_humano}
                  hint={pct(overview.transferidos_humano, overview.leads_entrantes)}
                  tone="amber"
                />
                <StatCard
