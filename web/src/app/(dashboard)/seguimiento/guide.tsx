    ...
    <details className="group rounded-xl border border-neutral-200 bg-white shadow-sm">
      ...
      <div className="space-y-3 px-5 pb-5 text-sm text-neutral-700">
        <p className="text-neutral-600">
          ...
          que tú apruebas. Lo configuras todo desde acá; no hace falta saber nada técnico.
        </p>
        ...
        <div className="space-y-1">
          ...
          <p>
            ...
            usarlas — eso es un trámite que se hace una sola vez. Acá solo pegas la plantilla que
        ...
        <div className="space-y-1">
          ...
          <ol className="list-decimal list-inside space-y-0.5 text-neutral-600">
            ...
            <li>
              Enciende el interruptor <span className="font-medium text-neutral-700">Seguimiento
