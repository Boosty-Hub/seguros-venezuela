...
// Cuerpo de la sección Seguimiento — pestaña de la Configuración unificada
// (/agent). El horario laboral se muestra en modo lectura dentro de esta
// misma pestaña (vía ConfigPanel); se EDITA en Comportamiento (single source
// of truth) para no duplicar el editor.
export async function SeguimientoBody() {
