...
// Cuerpo de la sección Kommo — vive como una pestaña más de /agent
// ("Configuración" unificada). Reúne el cableado con Kommo: conexión
// (subdominio + token), webhook entrante, publicación (campo destino +
// salesbot) y links al resto de la config de Kommo que vive donde se usa. El
// encendido/publicación/revisión del agente vive en la pestaña Identidad →
// "Encendido y publicación" (no se duplica acá).
export async function KommoBody({ kommoSaved }: { kommoSaved: boolean }) {
