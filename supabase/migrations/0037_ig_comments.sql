...
set
  ...
  comment_instructions = coalesce(comment_instructions, 'El mensaje vino de un comentario público en una publicación de Instagram. Tu respuesta sale por DM: reconoce el origen con naturalidad (ej: "vi tu comentario 😊"), anda directo al grano.')
